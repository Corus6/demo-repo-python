...
newlines = ['this', 1,2,5]
dummy_dict = {'name': 'John', 'age': 30}
text2 = "\nThis is an appended line."
with open("testfile.txt", "a") as file:
    file.write(str(newlines) + "\n")
    file.write(str(dummy_dict) + "\n")
    file.write(text2)
    file.close()

with open("testfile.txt", "r+") as file:
    content = file.read()
    content  = content.replace("appended", "inserted")
    print("here", content.find("appended"))
    print(content[130:138])
...
# content = file1.read()
#
# file2 = open("essay.txt", "r")
# content2 = file2.read()
#
# combined_output = ""
# file3 = open("output.txt", "w")
# file3.write(combined_output)
